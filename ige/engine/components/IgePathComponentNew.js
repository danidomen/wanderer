 ...
 */
var IgePathComponentNew = IgeEventingClass.extend({
	classId: 'IgePathComponentNew',
	componentId: 'pathnew',
	...
	init: function (entity, options) {
		...
		entity.addBehaviour('pathnew', this._updateBehaviour, false);
	},
	...
	transformPoint: function (point) {
		return new IgePoint3d(
			point.x + this._entity._parent._tileWidth,
			point.y + this._entity._parent._tileHeight,
			point.z
		);
	},
...
if (typeof(module) !== 'undefined' && typeof(module.exports) !== 'undefined') { module.exports = IgePathComponentNew; }